		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					...
					<%
					session = request.getSession(false); // Không tạo mới session nếu chưa tồn tại
					String userName = (String) session.getAttribute("username");
					if (session.getAttribute("account") == null) {
					%>
					<li><a href="/login_register/view/login.jsp">Log In</a></li>
					<li><a href="/login_register/view/Register.jsp">Sign up</a></li>
					<%
					} else {	
					%>
					<li><a href="/login_register/view/Info.jsp"><%= userName %></a></li>
					<li><a href="/login_register/logout">Log out</a></li>
					<%
					}
					%>
...
<div class="header">
	<div class="container">
		<a class="site-logo" href="/login_register/home"><img
		...
		<div class="header-navigation">
			<ul>
				...
				<li class="dropdown active"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="/login_register/home">Home Default</a></li>
